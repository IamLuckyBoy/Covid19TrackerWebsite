          ...
          <table class="table text-center" id="tb1">
           ...
           while($i > $latestTen){
               ...
               <tr class="text-captitalize text-white">
                  ...
                  <th style="color:#fff; background: #ffc107;">Today's Confirmed</th>
                  <th style="color:#fff; background: #008C76FF;">Today's Recovered </th>
                  <th style="color:#fff; background: #e91e7f;">Today's Deceased</th>
